...
export function CommentForm({ onSubmit, placeholder = "Leave a comment...", autoFocus }: CommentFormProps) {
  ...
  if (!session) {
    return (
      <div className="p-6 border border-border rounded-lg bg-surface text-center">
        <p className="text-text-secondary mb-4">Log in with GitHub to leave a comment.</p>
        <button
