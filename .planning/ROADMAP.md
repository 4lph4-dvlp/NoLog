...
- [x] 10-01-PLAN.md — Tracer: left sidebar collapses end-to-end (shared constants module, `@property` CSS, pre-hydration script, Server-Component slot refactor, client shell, hamburger) + resize/transition/reduced-motion

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 10-02-PLAN.md — Right sidebar: circular avatar toggle with ring cue and icon fallback, right-side wiring, `Profile.tsx` landmark fix
...
- [x] 10-04-PLAN.md — Verification battery: collapsed-state width measurement, delayed-onset pitfall checks, a11y battery, stop-ship battery, `10-EVIDENCE.md`
