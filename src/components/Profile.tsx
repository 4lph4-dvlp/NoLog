...
/**
 * Inline SVG icons for social brands (lucide-react removed brand icons).
 * Each is a tiny 18×18 SVG path.
 */
...
/** Map of SNS key → icon component */
const SNS_ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  github: GitHubIcon,
...
export function Profile() {
  ...
  // Collect active SNS entries (non-empty values)
  const activeLinks = Object.entries(sns).filter(
